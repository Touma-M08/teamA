...
<x-app-layout>
    <header class = "flex justify-between items-center py-4 md:py-8 mb-4 border-b-2 border-black">
      ...
      <nav class="hidden lg:flex gap-12">
            <a href="/search" class="text-gray-600 hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100 mr-10">検索画面へ</a>
      </nav>
      @if( auth() -> user() )
    ...
    <div class = "flex">
        <div class="bg-white py-6 sm:py-8 lg:py-12 w-1/2">
          <div class="max-w-screen-md px-4 md:px-8 mx-auto p-3">
            <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-4 md:mb-8 xl:mb-12 rounded border-2 border-black">{{$place->name}}の掲示板</h2>
            <div class="divide-y">
                @if(!$comments->isEmpty())
...
>>>>>>> 55163091482ba19bbfc640fa84d74d387347f92c
        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
            ...
            <!-- form - end -->
            <a href = "/places/{{$place->id}}">お店詳細ページに戻る</a>
          </div>
       </div>
